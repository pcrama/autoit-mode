...
(defun au3-mode--smie-rule (kind token)
  ...
  (ignore-errors (setq au3-smie-rule-parent-while-if (smie-rule-parent-p "While" "If" "Func" "Then" au3-mode-+newline+ au3-mode-+exp-inst-sep+)))
